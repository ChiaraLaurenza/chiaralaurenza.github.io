...
(function () {
  var T = {
    ...
    'Contemporary and jazz dancer, painter and choreographer, based in Munich.': { de: 'Contemporary- und Jazztänzerin, Malerin und Choreografin in München.', it: 'Danzatrice contemporanea e jazz, pittrice e coreografa a Monaco di Baviera.' },
    'Portrait coming soon': { de: 'Porträt folgt', it: 'Ritratto in arrivo' },
    'I am Chiara, a dancer and painter. I trained in contemporary dance, jazz and ballet at Iwanson in Munich, and I paint in acrylics.': { de: 'Ich bin Chiara, Tänzerin und Malerin. Ich habe bei Iwanson in München Contemporary, Jazz und Ballett trainiert und male mit Acryl.', it: 'Sono Chiara, danzatrice e pittrice. Mi sono formata in danza contemporanea, jazz e balletto alla Iwanson di Monaco e dipingo con colori acrilici.' },
    'In my Art & Dance Space, movement comes first: we dance a feeling, pause, and let the body decide the colours on the canvas.': { de: 'In meinem Art & Dance Space kommt die Bewegung zuerst: Wir tanzen ein Gefühl, halten inne und lassen den Körper die Farben auf der Leinwand wählen.', it: 'Nel mio Art & Dance Space il movimento viene prima: danziamo un’emozione, ci fermiamo e lasciamo che il corpo scelga i colori sulla tela.' },
    'Before dance became my path, I studied bioinformatics at TUM and LMU. It taught me to look closely at what happens inside a system — today, that system is the body.': { de: 'Bevor der Tanz mein Weg wurde, habe ich Bioinformatik an der TUM und LMU studiert. Dort habe ich gelernt, genau hinzuschauen, was in einem System passiert — heute ist dieses System der Körper.', it: 'Prima che la danza diventasse la mia strada, ho studiato bioinformatica alla TUM e alla LMU. Mi ha insegnato a guardare da vicino cosa succede dentro un sistema — oggi quel sistema è il corpo.' },
    'Contemporary': { de: 'Contemporary', it: 'Contemporanea' },
    'Showreel': { de: 'Showreel', it: 'Showreel' },
    'Showreel coming soon': { de: 'Showreel folgt', it: 'Showreel in arrivo' },
    'Training & Education': { de: 'Ausbildung', it: 'Formazione' },
    'Intensive dance training in classical ballet, jazz, contemporary dance and somatic practice.': { de: 'Intensive Tanzausbildung in klassischem Ballett, Jazz, Contemporary und somatischer Praxis.', it: 'Formazione intensiva in danza classica, jazz, contemporanea e pratica somatica.' },
    'B.Sc. Bioinformatics': { de: 'B.Sc. Bioinformatik', it: 'Laurea in Bioinformatica' },
    'TUM & LMU Munich': { de: 'TUM & LMU München', it: 'TUM & LMU Monaco' },
    'Thesis at RostLab on protein language models.': { de: 'Abschlussarbeit am RostLab zu Protein-Sprachmodellen.', it: 'Tesi al RostLab sui modelli linguistici per proteine.' },
    'Choreography & Performance': { de: 'Choreografie & Performance', it: 'Coreografia & Performance' },
    ...
    'Hip-hop choreography for eight dancers and a solo, performed in the Olympiapark.': { de: 'Hip-Hop-Choreografie für acht Tänzer:innen und ein Solo, aufgeführt im Olympiapark.', it: 'Coreografia hip-hop per otto danzatori e un assolo, eseguita all’Olympiapark.' },
    'Workshop & performance, City Birthday': { de: 'Workshop & Aufführung, Stadtgeburtstag', it: 'Workshop & performance, compleanno della città' },
    'Wittelsbacher Platz, Munich': { de: 'Wittelsbacher Platz, München', it: 'Wittelsbacher Platz, Monaco' },
    'Workshop and a 90-second choreography with a youth group for a public performance.': { de: 'Workshop und eine 90-sekündige Choreografie mit einer Jugendgruppe für eine öffentliche Aufführung.', it: 'Workshop e una coreografia di 90 secondi con un gruppo di ragazzi per un’esibizione pubblica.' },
    'Choreographer, music video': { de: 'Choreografin, Musikvideo', it: 'Coreografa, videoclip' },
    'Choreography for the music video, coaching the performers through the shooting day.': { de: 'Choreografie für das Musikvideo und Begleitung der Darsteller:innen am Drehtag.', it: 'Coreografia per il videoclip e accompagnamento dei performer durante le riprese.' },
    'Teaching & Organisation': { de: 'Unterricht & Organisation', it: 'Insegnamento & Organizzazione' },
    'Festival assistant': { de: 'Festivalassistenz', it: 'Assistente di festival' },
    'Tanzwerkstatt Europa, Munich': { de: 'Tanzwerkstatt Europa, München', it: 'Tanzwerkstatt Europa, Monaco' },
    'Artist care and festival organisation.': { de: 'Künstler:innenbetreuung und Festivalorganisation.', it: 'Assistenza agli artisti e organizzazione del festival.' },
    'Dance teacher': { de: 'Tanzlehrerin', it: 'Insegnante di danza' },
    'Dance Station, Munich': { de: 'Dance Station, München', it: 'Dance Station, Monaco' },
    'K-pop and TikTok dance classes for teenagers, including a stage show.': { de: 'K-Pop- und TikTok-Dance-Kurse für Jugendliche, inklusive Bühnenshow.', it: 'Corsi di K-pop e TikTok dance per adolescenti, con spettacolo finale.' },
    'Co-organiser, Korean Day': { de: 'Mitorganisation, Korean Day', it: 'Co-organizzatrice, Korean Day' },
    'Kongresshalle, Munich': { de: 'Kongresshalle, München', it: 'Kongresshalle, Monaco' },
    'K-pop showcase day with over 400 guests; twelve young dancers presented their own solos.': { de: 'K-Pop-Showcase mit über 400 Gästen; zwölf junge Tänzer:innen zeigten eigene Solos.', it: 'Giornata showcase K-pop con oltre 400 ospiti; dodici giovani danzatori hanno presentato i loro assoli.' },
